...
class Cometas_Medios():
    def __init__(self,x,y,angulo,lista):
        self.lista_cometa_medio = lista
        self.lista_cometa_medio.append([x , y, (angulo - 90) * 2, 4])

    def lista(self):
        return self.lista_cometa_medio

    def cometa_medio_funcao(screen, lista_cometa, speed):
        ...
        if len(lista_cometa) > 0:
            for cada_cometa in lista_cometa:
                ...
                rotated_image = pygame.transform.scale(rotated_image, (100, 100))
